...
public class DivesUtil {
    ...
    private static DivesUtil instance= null ;
    private DivesUtil(Context context) {
        getPhoneInformation(context);
    }
    public static   DivesUtil getInstance(Context context){
       if (instance==null){
           instance = new DivesUtil(context);
       }
        return instance;
    }
    ...
    private String generatorDeviceId() {
        String path = SDKUtils.getSKCardPath() + "/.zhangyue.data";
